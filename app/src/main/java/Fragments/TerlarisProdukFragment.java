 ...
 * Use the {@link TerlarisProdukFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TerlarisProdukFragment extends Fragment {
    ...
    public TerlarisProdukFragment() {
        // Required empty public constructor
    }

    public static TerlarisProdukFragment newInstance(String param1, String param2) {
        TerlarisProdukFragment fragment = new TerlarisProdukFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = (ViewGroup) inflater.inflate(R.layout.fragment_terlaris_produk, container, false);
        recyclerView = root.findViewById(R.id.fragment_terlaris_produk_recycler_view);
