 ...
 * Use the {@link SemuaTokoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SemuaTokoFragment extends Fragment {
     ...
     * @return A new instance of fragment SemuaTokoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SemuaTokoFragment newInstance(String param1, String param2) {
        SemuaTokoFragment fragment = new SemuaTokoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = (ViewGroup) inflater.inflate(R.layout.fragment_semua_toko, container, false);

        recyclerView = root.findViewById(R.id.fragment_semua_toko_recycler_view);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        String nama =getActivity().getIntent().getStringExtra("Nama");
        reference= FirebaseFirestore.getInstance().collection("listpasar")
                .document(nama).collection("TokoBeruang");

        FirestoreRecyclerOptions<Toko> options = new FirestoreRecyclerOptions.Builder<Toko>()
                .setQuery(reference,Toko.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Toko,TokoViewHolder>(options) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull TokoViewHolder tokoViewHolder, int i, @NonNull Toko toko) {
